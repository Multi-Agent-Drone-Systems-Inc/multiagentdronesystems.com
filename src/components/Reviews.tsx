...
const Reviews: React.FC<{ activeSection: string }> = ({ activeSection }) => {
  ...
  // Show reviews tab for all sections except home
  ...
  return (
    <>
      <button
        ...
        className={`fixed left-0 top-1/2 -translate-y-3/4 bg-orange-500 text-white w-6 sm:w-8 py-6 sm:py-8 z-30 transform transition-transform duration-300 hover:bg-orange-600 ${
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-0 top-0 bottom-0 w-full md:w-1/2 bg-white z-50 overflow-y-auto"
            >
              <button
                onClick={() => setIsOpen(false)}
        ...
        {isModalOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-1/2 top-0 -translate-x-1/2 -translate-y-0 w-full max-w-lg bg-white rounded-lg shadow-xl z-[60] p-6 mx-4 sm:mx-8 max-h-[90vh] overflow-y-auto"
