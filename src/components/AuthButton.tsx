...
import { User, LogOut, ShoppingCart, Heart, ChevronDown } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { useAuth } from '../contexts/AuthContext';
import AuthModal from './AuthModal';
import CartWishlistPanel from './CartWishlistPanel';
...
const AuthButton: React.FC = () => {
  ...
  useEffect(() => {
    if (showCartPanel || showWishlistPanel) {
      setShowDropdown(false);
    }
  }, [showCartPanel, showWishlistPanel]);
