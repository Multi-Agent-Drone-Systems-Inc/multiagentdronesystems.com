  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-black">
        {/* Black background behind drone */}
        <div className="absolute top-[65%] left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 w-1/2 bg-black rounded-lg z-10"></div>
        
        {/* Drone Image - On top */}
        <img
          src="images/hero.png"
          alt="Mountain landscape with drone"
          className="absolute top-[65%] left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 w-1/2 object-cover object-center rounded-lg z-20"
        />
      </div>
